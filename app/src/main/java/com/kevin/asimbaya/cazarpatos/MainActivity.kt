...
class MainActivity : AppCompatActivity() {
    ...
    fun procesarPuntajePatosCazados(nombreJugador:String, patosCazados:Int) {
        ...
        // Trata de obtener id del documento del ranking especifico,
        // si lo obtinene lo actualiza caso contrario lo crea
            ...
            .addOnSuccessListener { documents ->
                if (documents!= null &&
                    ...
                    if (jugadorLeido!!.huntedDucks < patosCazados)
                    {
                        ...
                        Log.w(EXTRA_LOGIN, "No se actualizo el puntaje, por ser menor al actual")
                    }
                }
                else {
    ...
    fun actualizarPuntajeJugador(idDocmento: String, jugador: Player) {
        val db = Firebase.firestore
        db.collection("ranking")
            .document(idDocmento)
            .set(jugador)
